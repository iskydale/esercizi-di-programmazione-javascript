...
var cats = 44;
var crows = 6; //numero gatti per file

var totrows = Math.ceil(cats/crows);

var missingcats = crows-(cats%crows);

console.log('Numero di file: '+totrows);
console.log("Numero di gatti mancanti nell'ultima fila: "+missingcats);
